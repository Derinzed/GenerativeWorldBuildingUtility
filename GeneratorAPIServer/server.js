...
const CALLBACK_URL = 'http://localhost:3000/auth/patreon/callback';
...
passport.use(new OAuth2Strategy({
    ...
    try {
        ...
        const response = await axios.get('https://www.patreon.com/api/oauth2/v2/identity?fields[user]=about,created,email,first_name,full_name,image_url,last_name,social_connections,thumb_url,url,vanity,is_creator&fields[member]=patron_status', {
